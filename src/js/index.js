...
botoes.forEach((botao, indice) => {
    botao.addEventListener("click", () => {
        //Obj 1 passo 3 - verificar se já existe um botão selecionado, se sim, devemos remover
        desselecionarBotao();

        //Obj 1 passo 2 - adicionar a classe "selecionado" no botão que o usuário clicou
        botao.classList.add("selecionado");

        //Obj 2 passo 3 - verificar se já exista um personagem selecionado, se sim, devemos remover a seleção dele
